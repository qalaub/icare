...
class _RegisterProfessional2WidgetState
  ...
  void initState() {
    ...
    _model.yearsFocusNode!.addListener(
      () async {
        _model.validationResult = await actions.validateExperience(
          _model.yearsTextController.text,
          _model.maxExperiencia,
        );
        _model.errorExperiencia = _model.validationResult!;
        safeSetState(() {});
