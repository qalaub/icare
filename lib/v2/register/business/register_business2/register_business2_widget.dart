...
class RegisterBusiness2Widget extends StatefulWidget {
  ...
  static String routeName = 'RegisterBusiness2';
  static String routePath = 'registerBusiness2';
...
class _RegisterBusiness2WidgetState extends State<RegisterBusiness2Widget>
  ...
  void initState() {
    ...
    _model.yearsFocusNode!.addListener(
      () async {
        _model.validationResult1 = await actions.validateExperience(
          _model.yearsTextController.text,
          _model.maxExperiencia,
        );
        _model.errorExperiencia = _model.validationResult1!;
        safeSetState(() {});
                                                                      ...
                                                                      () async {
                                                                        _model.ndisexist2 =
                                                                          ...
                                                                          queryBuilder: (usersRecord) =>
                                                                            ...
                                                                            'ndis',
                                                                            isEqualTo:
                                                                                _model.ndisTextController.text,
                                                                          ),
                                                                        );
                                                        ...
                                                        : () async {
                                                            ...
                                                            _model.termsAccept =
                                                                _model
                                                                    .termsValue!;
                                                            safeSetState(() {});
                                                            if ((FFAppState().verifyForm.same == true) &&
                                                                _model
                                                                    .termsAccept &&
                                                                (FFAppState()
                                                                        .verifyForm
