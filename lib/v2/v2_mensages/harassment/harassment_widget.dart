...
class HarassmentWidget extends StatefulWidget {
  const HarassmentWidget({
    super.key,
  ...
  static String routeName = 'Harassment';
  static String routePath = 'harassment';

  @override
  State<HarassmentWidget> createState() => _HarassmentWidgetState();
}

class _HarassmentWidgetState extends State<HarassmentWidget> {
  late HarassmentModel _model;
