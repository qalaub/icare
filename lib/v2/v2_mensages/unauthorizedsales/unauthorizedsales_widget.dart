...
import 'unauthorizedsales_model.dart';
export 'unauthorizedsales_model.dart';

class UnauthorizedsalesWidget extends StatefulWidget {
  const UnauthorizedsalesWidget({
    super.key,
  ...
  static String routeName = 'Unauthorizedsales';
  static String routePath = 'unauthorizedsales';

  @override
  State<UnauthorizedsalesWidget> createState() =>
      _UnauthorizedsalesWidgetState();
}

class _UnauthorizedsalesWidgetState extends State<UnauthorizedsalesWidget> {
  late UnauthorizedsalesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnauthorizedsalesModel());
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await actions.sendReportEmail(
                        ...
                        widget.report!,
                        currentUserEmail,
                        'This user is promoting or selling items without authorization.',
                      );
