...
class SomeoneelseWidget extends StatefulWidget {
  const SomeoneelseWidget({
    super.key,
  ...
  static String routeName = 'someoneelse';
  static String routePath = 'someoneelse';

  @override
  State<SomeoneelseWidget> createState() => _SomeoneelseWidgetState();
}

class _SomeoneelseWidgetState extends State<SomeoneelseWidget> {
  late SomeoneelseModel _model;
