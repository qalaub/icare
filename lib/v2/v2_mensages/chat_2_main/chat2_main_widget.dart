                                                    ...
                                                    builder: (context) {
                                                      if (chat2MainVarItem
                                                        ...
                                                        return Padding(
                                                          ...
                                                          child: StreamBuilder<
                                                              UsersRecord>(
                                                            stream: UsersRecord.getDocument(chat2MainVarItem
                                                                .users
                                                                .where((e) => e
                                                                            .id ==
                                                                        currentUserReference
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              future: UsersRecord.getDocumentOnce(chat2MainVarItem.users.where((e) => e != currentUserReference).toList().lastOrNull!),
                                                                              builder: (context, snapshot) {
                                                                                // Customize what your widget looks like when it's loading.
                                                                                if (!snapshot.hasData) {
                                                                                  return Center(
                                                                            ...
                                                                            children: [
                                                                              Expanded(
                                                                                child: Padding(
                                                                                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 12.0, 0.0),
                                                                                  child: Text(
                                                                                    functions.upperCaseFirstLetter(rowUsersRecord.firtsName),
                                                                                    textAlign: TextAlign.start,
                                                                                    style: FlutterFlowTheme.of(context).bodyLarge.override(
                                                                                          font: GoogleFonts.poppins(
                                                                                            fontWeight: FontWeight.bold,
