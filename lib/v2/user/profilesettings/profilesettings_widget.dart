...
class ProfilesettingsWidget extends StatefulWidget {
  const ProfilesettingsWidget({
    super.key,
    String? initialSur,
  }) : this.initialSur = initialSur ?? 'location';

  final String initialSur;
...
class _ProfilesettingsWidgetState extends State<ProfilesettingsWidget> {
  ...
  void initState() {
    ...
    _model.textFieldNewEmailTextController ??= TextEditingController();
    _model.textFieldNewEmailFocusNode ??= FocusNode();

    _model.textFieldCurrentTextController ??= TextEditingController();
    _model.textFieldCurrentFocusNode ??= FocusNode();
                                                  ...
                                                  child: Align(
                                                    alignment:
                                                        AlignmentDirectional(
                                                            -1.0, 0.0),
                                                    child: Text(
                                                      'You can modify the email in case you entered it incorrectly in the registry',
                                                      textAlign:
                                                          TextAlign.start,
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Stack(
                                                        children: [
                                                          TextFormField(
                                                            controller: _model
                                                                .textFieldNewEmailTextController,
                                                            focusNode: _model
                                                                .textFieldNewEmailFocusNode,
                                                            onFieldSubmitted:
                                                                (_) async {
                                                              context.safePop();
                                                            },
                                                      ...
                                                      child: Align(
                                                        ...
                                                        child: TextFormField(
                                                          key: ValueKey(
                                                              'lastName'),
                                                          controller: _model
                                                              .textFieldCurrentTextController,
                                                          focusNode: _model
                                                              .textFieldCurrentFocusNode,
                                                          autofocus: false,
                                                          textCapitalization:
                                                              TextCapitalization
                                                                  .words,
                                                          obscureText: !_model
                                                              .textFieldCurrentVisibility,
                                                          decoration:
                                                              InputDecoration(
                                                            isDense: true,
                                                            hintText:
                                                            ...
                                                            suffixIcon: InkWell(
                                                              ...
                                                              focusNode: FocusNode(
                                                                  skipTraversal:
                                                                      true),
                                                              child: Icon(
                                                                _model.textFieldCurrentVisibility
                                                                    ? Icons
                                                                        .visibility_outlined
                                                                    : Icons
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                                  ...
                                                  child: Stack(
                                                    ...
                                                    children: [
                                                      Align(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .textFieldOldPassTextController,
                                                          focusNode: _model
                                                              .textFieldOldPassFocusNode,
                                                          onChanged: (_) =>
                                                              EasyDebounce
                                                                  .debounce(
                                                            '_model.textFieldOldPassTextController',
                                                            Duration(
                                                                milliseconds:
                                                                    10),
                                                            () => safeSetState(
                                                  ...
                                                  child: Stack(
                                                    ...
                                                    children: [
                                                      Align(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .textFieldNewPassTextController,
                                                          focusNode: _model
                                                              .textFieldNewPassFocusNode,
                                                          onChanged: (_) =>
                                                              EasyDebounce
                                                                  .debounce(
                                                            '_model.textFieldNewPassTextController',
                                                            Duration(
                                                                milliseconds:
                                                                    10),
                                                            () => safeSetState(
                                        ...
                                        FFButtonWidget(
                                          onPressed: ((_model.textFieldOldPassTextController
                                                              .text ==
                                                          '') ||
                                                  (_model.textFieldNewPassTextController
                                                              .text ==
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text(
                                                              'Invalid password'),
                                                          content: Text(
                                                              'The current password is incorrect o empty'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                        ...
                        if (_model.queryResults.length > 0)
                          Align(
                            ...
                            child: Container(
                              ...
                              height: MediaQuery.sizeOf(context).height * 0.648,
                              decoration: BoxDecoration(
                                            ...
                                            itemBuilder:
                                              ...
                                              return InkWell(
                                                ...
                                                child: MapbuscarWidget(
                                                  key: Key(
                                                      'Keyx2p_${newqueryIndex}_of_${newquery.length}'),
                                                  icon: Icon(
                                                    Icons.location_on,
                                                    color: Color(0xFFD26AD2),
                                                  ),
                                                  text:
                                                      newqueryItem.description,
                                                ),
                                              );
                                            },
                                          );
