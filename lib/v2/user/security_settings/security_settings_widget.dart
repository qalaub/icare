...
class _SecuritySettingsWidgetState extends State<SecuritySettingsWidget> {
  ...
  void initState() {
    ...
    _model.nuevoCorreoElectronicoTextController ??= TextEditingController();
    _model.nuevoCorreoElectronicoFocusNode ??= FocusNode();

    _model.confirmNuevoCorreoElectronicoTextController ??=
        TextEditingController();
    _model.confirmNuevoCorreoElectronicoFocusNode ??= FocusNode();
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                                ...
                                                child: Align(
                                                  alignment:
                                                      AlignmentDirectional(
                                                          -1.0, 0.0),
                                                  child: Text(
                                                    'If you want to change email, press the button',
                                                  ...
                                                  child: Stack(
                                                    ...
                                                    children: [
                                                      Align(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .nuevoCorreoElectronicoTextController,
                                                          focusNode: _model
                                                              .nuevoCorreoElectronicoFocusNode,
                                                          onChanged: (_) =>
                                                              EasyDebounce
                                                                  .debounce(
                                                            '_model.nuevoCorreoElectronicoTextController',
                                                            Duration(
                                                                milliseconds:
                                                                    10),
                                                            () async {
                                                              safeSetState(() {
                                                                _model.nuevoCorreoElectronicoTextController
                                                                        ?.text =
                                                                    functions.cleanEmailInput(_model
                                                                        .nuevoCorreoElectronicoTextController
                                                                        .text);
                                                              });
                                                            },
                                                  ...
                                                  child: Stack(
                                                    ...
                                                    children: [
                                                      Align(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .confirmNuevoCorreoElectronicoTextController,
                                                          focusNode: _model
                                                              .confirmNuevoCorreoElectronicoFocusNode,
                                                          onChanged: (_) =>
                                                              EasyDebounce
                                                                  .debounce(
                                                            '_model.confirmNuevoCorreoElectronicoTextController',
                                ...
                                FFButtonWidget(
                                  onPressed: ((_model.nuevoCorreoElectronicoTextController
                                                      .text ==
                                                  '') ||
                                          (_model.confirmNuevoCorreoElectronicoTextController
                                                      .text ==
                                      ...
                                      ? null
                                      : () async {
                                          await actions.sendConfirmEmailUser(
                                            valueOrDefault(
                                          ...
                                          ScaffoldMessenger.of(context)
                                            ...
                                            SnackBar(
                                              content: Text(
                                                'Application sent successfully, check your inbox',
                                                style: TextStyle(
                                                  color: FlutterFlowTheme.of(
                                                          context)
                                                      .primaryText,
