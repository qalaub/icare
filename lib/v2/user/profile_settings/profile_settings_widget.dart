...
class _ProfileSettingsWidgetState extends State<ProfileSettingsWidget> {
  ...
  void initState() {
    ...
    _model.phoneFocusNode!.addListener(
      () async {
        if (!functions.validatePhoneNumber(_model.phoneTextController.text)) {
                                  ...
                                  children: [
                                                        ...
                                                        child: Align(
                                                          alignment:
                                                              AlignmentDirectional(
                                                                  0.0, 0.0),
                                                          child: Text(
                                                            'You can modify your companyname with the one you feel  most comfortable with.',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                    ...
                                    Align(
                                      ...
                                      child: Form(
                                        ...
                                        child: Visibility(
                                          visible: currentUserDocument?.rol !=
                                              Roles.user,
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                          ...
                                                          child: Align(
                                                            alignment:
                                                                AlignmentDirectional(
                                                                    -1.0, 0.0),
                                                            child: Text(
                                                              'In this section you can change youryears of experience if it is different now.',
                                                              textAlign:
                                                                  TextAlign
                                                                      .start,
                                                              style: FlutterFlowTheme
                                                                      ...
                                                                      if (!_model
                                                                        ...
                                                                        ScaffoldMessenger.of(context)
                                                                          ...
                                                                          SnackBar(
                                                                            content:
                                                                                Text(
                                                                              'Please enter a valid number between 1 and 47.',
                                                                              style: TextStyle(
                                                                ...
                                                                child:
                                                                  ...
                                                                  multiSelectController: _model
                                                                      ...
                                                                      _model.dropDownValue ??=
                                                                          List<
                                                                              String>.from(
                                                                    (currentUserDocument?.disabilities.toList() ??
                                                                            []) ??
                                                                        [],
                                                                  )),
                                                                  options: [
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return InkWell(
                                                    ...
                                                    child: MapbuscarWidget(
                                                      key: Key(
                                                          'Keyu3g_${newqueryIndex}_of_${newquery.length}'),
                                                      icon: Icon(
                                                        Icons.location_on,
                                                        color:
                                                            Color(0xFFD26AD2),
