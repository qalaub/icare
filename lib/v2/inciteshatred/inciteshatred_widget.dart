...
class InciteshatredWidget extends StatefulWidget {
  const InciteshatredWidget({
    super.key,
  ...
  static String routeName = 'inciteshatred';
  static String routePath = 'inciteshatred';

  @override
  State<InciteshatredWidget> createState() => _InciteshatredWidgetState();
}

class _InciteshatredWidgetState extends State<InciteshatredWidget> {
  late InciteshatredModel _model;
