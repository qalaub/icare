                            ...
                            Align(
                              ...
                              child: CheckboxListTile(
                                value: _model.age1Value ??= FFAppState()
                                        .filtersPage
                                        .age
                                        .contains(FFAppConstants.agesType[2]) ==
                                    true,
                                onChanged: (newValue) async {
                                  setState(() => _model.age1Value = newValue!);
                                },
                                title: Text(
                                  '18-25 years',
                                  style: FlutterFlowTheme.of(context)
                            ...
                            Align(
                              ...
                              child: CheckboxListTile(
                                value: _model.age2Value ??= FFAppState()
                                        .filtersPage
                                        .age
                                        .contains(FFAppConstants.agesType[1]) ==
                                    true,
                                onChanged: (newValue) async {
                                  setState(() => _model.age2Value = newValue!);
                                },
                                title: Text(
                                  '25-40 years',
                                  style: FlutterFlowTheme.of(context)
                            ...
                            Align(
                              ...
                              child: CheckboxListTile(
                                value: _model.age3Value ??= FFAppState()
                                        .filtersPage
                                        .age
                                        .contains(FFAppConstants.agesType[0]) ==
                                    true,
                                onChanged: (newValue) async {
                                  setState(() => _model.age3Value = newValue!);
                                },
                                title: Text(
                                  '40-65+ years',
                                  style: FlutterFlowTheme.of(context)
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              alignment: const AlignmentDirectional(0.0, -0.46),
                              child: CheckboxListTile(
                                value: _model.coordinatorsValue ??= FFAppState()
                                        .filtersPage
                                        .services
                                        .contains(
                            ...
                            Align(
                              alignment: const AlignmentDirectional(0.0, 0.13),
                              child: CheckboxListTile(
                                value: _model.therapeuticValue ??= FFAppState()
                                        .filtersPage
                                        .services
                                        .contains(
                            ...
                            Align(
                              ...
                              child: CheckboxListTile(
                                value: _model.homeValue ??= FFAppState()
                                    ...
                                    true,
                                onChanged: (newValue) async {
                                  setState(() => _model.homeValue = newValue!);
                                },
                                title: Text(
                                  'Home Maintenance ',
                                  style: FlutterFlowTheme.of(context)
                          ...
                          onPressed: () async {
                            ...
                            FFAppState().updateFiltersPageStruct(
                              (e) => e
                                ...
                                ..updateServices(
                                  (e) => e.add(_model.coordinatorsValue == true
                                      ? ' Coordinator'
                                      : ' '),
                                ),
                            );
