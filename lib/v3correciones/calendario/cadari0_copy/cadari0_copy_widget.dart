...
export 'cadari0_copy_model.dart';

class Cadari0CopyWidget extends StatefulWidget {
  const Cadari0CopyWidget({
    super.key,
    this.bussinesRef,
    bool? isBussines,
  ...
  static String routeName = 'cadari0Copy';
  static String routePath = 'cadari0Copy';

  @override
  State<Cadari0CopyWidget> createState() => _Cadari0CopyWidgetState();
}

class _Cadari0CopyWidgetState extends State<Cadari0CopyWidget> {
  late Cadari0CopyModel _model;
                                ...
                                onPressed: () async {
                                  if ((FFAppState()
                                    ...
                                    if (widget.isBussines) {
                                      ...
                                      context.pushNamed(
                                        RegisterPfofesional4CopyWidget
                                            .routeName,
                                        queryParameters: {
